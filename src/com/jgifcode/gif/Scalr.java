 ...
 * allows the logging to be light weight and easy to capture while adding no
...
public class Scalr {
	 ...
	 *             operations.
	 */
	public static BufferedImage crop(final BufferedImage src, final int width,
	 ...
	 *             operations.
	 */
	public static BufferedImage crop(final BufferedImage src, final int x,
	 ...
	 *             operations.
	 */
	public static BufferedImage pad(final BufferedImage src, final int padding,
			final BufferedImageOp... ops) throws IllegalArgumentException,
			ImagingOpException {
	 ...
	 */
	public static BufferedImage pad(final BufferedImage src, final int padding,
			final Color color, final BufferedImageOp... ops)
			throws IllegalArgumentException, ImagingOpException {
		long t = System.currentTimeMillis();
	 ...
	 *             operations.
	 */
	public static BufferedImage resize(final BufferedImage src,
	 ...
	 */
	public static BufferedImage resize(final BufferedImage src,
			Method scalingMethod, final Mode resizeMode, int targetWidth,
			int targetHeight, final BufferedImageOp... ops)
			throws IllegalArgumentException, ImagingOpException {
		long t = System.currentTimeMillis();
	 ...
	 * @see Rotation
	 */
	public static BufferedImage rotate(final BufferedImage src,
	 ...
	 */
	protected static void log(final int depth, final String message,
			final Object... params) {
		if (Scalr.DEBUG) {
	 ...
	 */
	protected static Method determineScalingMethod(final int targetWidth,
			final int targetHeight, final float ratio) {
	 ...
	 */
	protected static BufferedImage scaleImage(final BufferedImage src,
			final int targetWidth, final int targetHeight,
			final Object interpolationHintValue) {
