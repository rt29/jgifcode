...
public class GifDecoder {
	...
	static class GifFrame {
		public int ix, iy, iw, ih; // current image rectangle
		...
		public GifFrame(final BufferedImage im, final int del, final int ix,
	 ...
	 * @return BufferedImage representation of frame, or null if n is invalid.
	 */
	public GifFrame getGifFrame(final int n) {
		if ((n >= 0) && (n < frameCount)) {
			return frames.get(n);
		}
		return null;
	...
	protected void readImage() {
		...
		frames.add(new GifFrame(image, delay, ix, iy, iw, ih)); // add image to
																// frame list
