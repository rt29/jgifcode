 ...
 * </pre>
 * 
 * May be used for any purpose, however, refer to the Unisys LZW patent for
 * restrictions on use of the associated LZWEncoder class.
 * 
 * @author
 * 
 * 
...
public class AnimatedGifEncoder {
	 ...
	 */
	public boolean addFrame(final BufferedImage im, final int x, final int y) {
		if ((im == null) || !started) {
			return false;
		}
		boolean ok = true;
		try {
			...
			image = im;
			getImagePixels(x, y); // convert to correct format if necessary
	 ...
	 */
	protected void getImagePixels(final int x, final int y) {
